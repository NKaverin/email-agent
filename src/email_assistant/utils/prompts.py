...
default_background = """ 
I'm Nikolai, a software engineer.
"""
...
In general:
- Do not add any filler words. 
- Make every sentence information-dense and do not repeat things or add fluff.  
- Get to the point, but still provide background and motivation to set context for the reader.  
- Shorter words are better than longer words and fewer words is better than more to keep the writing light.
- Avoid multiple examples if one clear point suffices
- Make questions genuinely neutral rather than telegraphing the answer
- Remove sentences that restate the premise: After introducing a concept, don't add a sentence explaining why it matters trust the reader understands from context.
- Cut transitional fluff: Avoid sentences like "Understanding X helps you Y" or "This is important because..." Jump straight to the actionable content.
- Combine related ideas: Instead of "X is important. X helps with Y. Here's how X works..." just say "X helps with Y: [explanation]
- Start sections with the meat: Lead with specific advice, not general statements about importance or benefits.
- Replace em dashes with simpler punctuation: Use periods, commas, or colons instead of em dashes unless truly needed for emphasis or clarity.
- Cut qualifying phrases: Remove phrases like "if you focus on the right features" or "when done correctly" that don't add concrete information.
- Use direct statements: Instead of "X is important—here's why" just state what X does.
- Remove setup phrases: Delete phrases like "It's worth noting that" or "The key point is" and just state the point directly.
