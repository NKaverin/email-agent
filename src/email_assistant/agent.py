...
from email_assistant.utils.tools import get_tools, get_tools_by_name
from email_assistant.utils.tools.gmail.prompt_templates import GMAIL_TOOLS_PROMPT
from email_assistant.utils.tools.gmail.gmail_tools import mark_as_read
from email_assistant.utils.prompts import triage_system_prompt, triage_user_prompt, agent_system_prompt, default_triage_instructions, default_background, default_response_preferences, default_cal_preferences, MEMORY_UPDATE_INSTRUCTIONS, MEMORY_UPDATE_INSTRUCTIONS_REINFORCEMENT
from email_assistant.utils.state import State, RouterSchema, StateInput, UserPreferences
from email_assistant.utils.utils import parse_gmail, format_for_display, format_gmail_markdown
    ...
    if last_message.tool_calls:
        for tool_call in last_message.tool_calls: 
            if tool_call["name"] == "Done":
                # When the assistant finishes the task, store the interaction for long-term memory
                update_memory(store, ("email_assistant", "background"), state["messages"] + [{
                    "role": "user",
                    "content": "The assistant has completed the task for this email and marked it as done. Store this exchange for future context."
                }])
